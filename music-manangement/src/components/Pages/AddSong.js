        ...
        >
          ...
          <div className="row">
            <div className="col-md-7" style={{paddingTop:''}}>
              ...
              <div className="form-group">
                <input style={{margin:'4px'}} type="text" name="albumTitle" className="form-control" placeholder="Album" />
              </div>
              <div className="form-group">
              ...
              <Button style={{borderRadius:'4px'}} type="submit" onClick={info}>
                Add Your Song
              </Button>,
              </div>
            </div>
            <div className="col-md-5">
              <div className="form-group">
                ...
                <div className="form-group">
                  <input style={{width:'90%'}} type="text" name="fileUrl" className="form-control" placeholder="Audio Url " />
                </div>
              </div>
            </div>
          </div>
